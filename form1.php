...
<body>
    ...
    if ($_SESSION["canal_id"] > 2) {
        $sqln = "SELECT * FROM covidusuarios 
        where (nivel ='10' or nivel ='22') 
        and activo ='1' 
    ...
    <Form Action="form2.php" Method="post">
        ...
        <tr>
            <Th colspan=2>
                <h2>Formulario de creación de pedidos</h2>
            </th>
        </tr>

        <td>Nombre:</td>
        <td><Input Type=Text Size=40 Maxlenght=100 Name="nombre" id="nombre" required> </td>
        </tr>


        <td>Cedula / RUC:</td>
        <td><Input Type=Text Size=40 Maxlenght=100 Name="cedula" id="cedula" required onKeyPress="return numbersonly(this, event)"></td>
        </tr>


        <td>Celular:</td>
        <td><Input Type=Text Size=10 Maxlenght=10 Name="celular" id="celular" required onKeyPress="return numbersonly(this, event)"></td>
        </tr>
        </tr>
        <td>Mail:</td>
        <td><Input Type=Text Size=40 Maxlenght=40 Name="mail" id="mail" required></td>
        </tr>
        </tr>
        <td>Ciudad:</td>
        <td>
        ...
        <td><strong> Computron desde donde se factura:<strong></td>
        <td>
            <div id="ordenbodegaf">
        ...
        <td></td>
        <td>
            <Center><Input Type=Submit Value="Ingresar venta" class="btn btn-sm btn-primary"></Center>
        </td>
        </table>
