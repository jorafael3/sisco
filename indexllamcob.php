...
echo "<H2>Listado llamadas de cobro:<br></H2>";
...
$sql = "
 ...
 and a.aprobadocc='' and b.llamadas >=1
 GROUP BY a.secuencia,a.`nombres` order by llamadas desc 
 ";
...
if ($row['formapago']=='Tarjeta'){echo "<td>".$row['formapago']."<br>(".$row['tipotarjeta'].")</td>";} else {echo "<td>".$row['formapago']."</td>";}
...
if ($row['doc1']){
	echo "<td align=center  ><a href=muestraimagen.php?sec=$sec&a=1> <center> <img src='images/cedula.png' alt='Vista Previa' border='0' height='24' width='24'></center></td>";}else {
...
if ($row['doc2']){
	echo "<td align=center  ><a href=muestraimagen.php?sec=$sec&a=2> <center> <img src='images/tarjeta.png' alt='Vista Previa' border='0' height='24' width='24'></center></td>";}else {
	echo "<td align=center  ><a href=cargadocumentos.php?sec=$sec> <center> <img src='images/documents.png' alt='Vista Previa' border='0' height='24' width='24'></center></td>";}
if ($row['doc3']){
	echo "<td align=center  ><a href=muestraimagen.php?sec=$sec&a=3> <center> <img src='images/voucher.png' alt='Vista Previa' border='0' height='24' width='24'></center></td>";}else {
	echo "<td align=center  ><a href=cargadocumentos.php?sec=$sec> <center> <img src='images/documents.png' alt='Vista Previa' border='0' height='24' width='24'></center></td>";}
