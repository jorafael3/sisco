...
echo "<h2>Cobranza tarjeta de crédito ".$sec."</h2>";
...
?>
	<div id="izquierda">
		...
		<!-- <Form Action="apruebacct2.php" Method="post" >



		<table border=0 cellpadding=0 cellspacing=0 >
		<tr> 
		<TD><h2>Aprobacion Callcenter tarjeta de crédito</h2></td>
		...
		<td colspan = 2><br><Center><Input Type=Submit Value="APLICAR EL PAGO" class="btn btn-sm btn-primary" name="aplicar"></Center>
		<br><Center><Input Type=Submit Value="No contactado" class="btn btn-sm btn-primary" name="contacto"></Center>
	...
	<div id="derecha">
		<?php
		require("conexion.php");
		$sql1 = "SELECT * FROM covidcobranzas where transaccion = '$sec' ";
		$result1 = mysqli_query($con, $sql1);
		echo "<table border=0 cellpadding=1 cellspacing=3 width=65%></tr>";
		echo "<th colspan = 3><center><h3>Llamadas anteriores:</h3><center></th></tr>";		
