...
<form method="POST" action="uploadcredito.php" enctype="multipart/form-data">


<center><table border=0 cellpadding=1 cellspacing=3 width=65%></center>
 <th colspan =4><h3>Adjuntar documentación de crédito</h3></th><tr>
 <th >Registro:</th>
...
if ($row1['doc1']){echo "  <br><th>Solicitud: </th><td colspan =2>".$row1['doc1']."<td><tr>";} else {echo "  <br><th>Solicitud: </th><td colspan =2><input type=\"file\" name=\"file_array[0]\"  ><td><tr>";}
if ($row1['doc2']){echo "  <br><th>Tabla de amortización: </th><td colspan =2>".$row1['doc2']."<td><tr>";} else {echo "  <br><th>Tabla de amortización: </th><td colspan =2><input type=\"file\" name=\"file_array[1]\"  ><td><tr>";}
if ($row1['doc3']){echo "  <br><th>Pagaré: </th><td colspan =2>".$row1['doc3']."<td><tr>";} else {echo "  <br><th>Pagaré: </th><td colspan =2><input type=\"file\" name=\"file_array[2]\"  ><td><tr>";}
if ($row1['doc4']){echo "  <br><th>Contrato de venta: </th><td colspan =2>".$row1['doc4']."<td><tr>";} else {echo "  <br><th>Contrato de venta: </th><td colspan =2><input type=\"file\" name=\"file_array[3]\"  ><td><tr>";}
if ($row1['doc5']){echo "  <br><th>Comunicado importante: </th><td colspan =2>".$row1['doc5']."<td><tr>";} else {echo "  <br><th>Comunicado importante: </th><td colspan =2><input type=\"file\" name=\"file_array[4]\"  ><td><tr>";}
