...
//  a.fechaanulada, a.valortotal, a.pdf, a.cierrefecha, a.cierreusuario, a.bodega, a.numcuotas, a.valorcuotas,a.tcusuario, a.tipotarjeta,  
...
if ($_SESSION["canal_id"]  > 2) {
	$sql = "
		SELECT a.secuencia, a.cedula, a.nombres, a.celular, a.ciudad, a.venta, a.direccion, a.referencias, a.formapago, a.fecha,a.factura, a.ordenweb, 
		...
		a.cierrefecha, a.cierreusuario, a.bodega as bodegaf , a.numcuotas, a.valorcuotas,a.tcusuario, a.tipotarjeta, a.l2p, a.l2pconf, a.valorfactura,d.bodega as bodegareti, a.comentarios,
		b.transaccion, b.doc1, b.doc2, b.doc3, b.doc4, b.doc5 ,
...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<td>" . $row['bodegareti'] . "</td>";
	echo "<td>" . $row['ordencomentario'] . "</td>";
	...
	if (($row['estado'] == "Paymentez" or $row['estado'] == "Tarjeta" or $row['estado'] == "Transferencia" or $row['estado'] == "LinkToPay" or $row['estado'] == "Tienda") and ($nivel == "20" and $row['factura'] == "")) {
	...
	echo "<td><a href=cajacoment1.php?sec=$sec>" . $row['coment'] . "</a></td>";
