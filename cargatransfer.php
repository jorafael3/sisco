...
<form method="POST" action="uploadtransferencia.php" enctype="multipart/form-data">
...
if ($row1['doc1']){echo "  <br><th>Transferencia: </th><td colspan =2>".$row1['doc1']."<td><tr>";} else {echo "  <br><th>Transferencia: </th><td colspan =2><input type=\"file\" name=\"file_array[0]\"  ><td><tr>";}
