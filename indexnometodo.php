...
echo "<H2>Facturas sin método de envío asigandas:<br></H2>";
...
$sql = "SELECT * FROM covidsales where despachofinal ='' and estado ='Por despachar' and anulada <>'1' order by secuencia desc ";
