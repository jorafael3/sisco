...
este activa o desactiva el dropdown de forma de pago
 -->
    <script type="text/javascript">
        function activaestado(onoff) {
            if (onoff == 0) {
                document.getElementById("estadoorden").disabled = true;
            }
            if (onoff == 1) {
                document.getElementById("estadoorden").disabled = false;
            }
        }
    </script>
...
<FORM METHOD="POST" ACTION="reporte_menu2.php" onsubmit="return consulta()">
 -->
                    <FORM METHOD="POST" ACTION="rep_detalle.php" onsubmit="return consulta()">
                        ...
                        <input type="checkbox" name="estadorden" value="0" onclick="if (this.checked) {activaestado(1)} else {activaestado(0)}">Estado Orden:
                        <select name="estadoorden" id="estadoorden">
                            <option value="Facturado">Facturado</option>
                            <option value="Verif. pago">Verif.Pago</option>
                        </select>
                        <script type="text/javascript">
                            {
                                document.getElementById("estadoorden").disabled = true;
